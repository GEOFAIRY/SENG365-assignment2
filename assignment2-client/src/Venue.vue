  ...
  <div id="venuesPage">
    ...
    <div id="filters">
      ...
      <div id="starFilter">
        ...
        <input class="starFilterButton" type="radio" name="noStarFilter" id="noStarFilter" value="0" v-model="minimumStarRating" v-on:change="getVenues()">
        <label for="noStarFilter">None</label>
        <input class="starFilterButton" type="radio" name="oneStar" id="oneStar" value="1" v-model="minimumStarRating" v-on:change="getVenues()">
        <label for="oneStar">1</label>
        <input class="starFilterButton" type="radio" name="twoStar" id="twoStar" value="2" v-model="minimumStarRating" v-on:change="getVenues()">
        <label for="twoStar">2</label>
        <input class="starFilterButton" type="radio" name="threeStar" id="threeStar" value="3" v-model="minimumStarRating" v-on:change="getVenues()">
        <label for="threeStar">3</label>
        <input class="starFilterButton" type="radio" name="fourStar" id="fourStar" value="4" v-model="minimumStarRating" v-on:change="getVenues()">
        <label for="fourStar">4</label>
        <input class="starFilterButton" type="radio" name="fiveStar" id="fiveStar" value="5" v-model="minimumStarRating" v-on:change="getVenues()">
        <label for="fiveStar">5</label>
      </div>

      <div id="starFilter">
        <p>Cost Rating</p>
        <input class="costFilterButton" type="radio" name="noFilter" id="noFilter" value="5" v-model="maxCostRating" v-on:change="getVenues()">
        <label for="noFilter">None</label>
        <input class="costFilterButton" type="radio" name="freeCost" id="freeCost" value="0" v-model="maxCostRating" v-on:change="getVenues()">
        <label for="freeCost">Free</label>
        <input class="costFilterButton" type="radio" name="oneCost" id="oneCost" value="1" v-model="maxCostRating" v-on:change="getVenues()">
        <label for="oneCost">1</label>
        <input class="costFilterButton" type="radio" name="twoCost" id="twoCost" value="2" v-model="maxCostRating" v-on:change="getVenues()">
        <label for="twoCost">2</label>
        <input class="costFilterButton" type="radio" name="threeCost" id="threeCost" value="3" v-model="maxCostRating" v-on:change="getVenues()">
        <label for="threeCost">3</label>
        <input class="costFilterButton" type="radio" name="fourCost" id="fourCost" value="4" v-model="maxCostRating" v-on:change="getVenues()">
    ...
    <div id="Venues">
      ...
      <div>
        <div class="venueTable" v-for="venue in venues" v-bind:key="venue.id">
